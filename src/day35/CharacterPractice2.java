      ...
      //  String.valueOf(myChar);
        ...
        for (char each : allChars) {
            ...
            if (Character.isDigit(each)) {
                ...
                int eachNum2 = Integer.parseInt(String.valueOf(each));
                int eachNum3 = Integer.parseInt(Character.toString(each));
        ...
        for (int x = 0; x < str.length(); x++) {
            ...
            if (Character.isDigit(str.charAt(x))) {
                ...
                sum4 += Integer.parseInt(Character.toString(str.charAt(x)));
            }
