...
//        System.out.println("strYear = " + strYear);
        System.out.println(getYearOutOfCaseNumber("CBM2019-00032"));
        System.out.println(getYearOutOfCaseNumber("IPR2009-01042"));
        System.out.println(getYearOutOfCaseNumber("CBM2001-10133"));

        int Year = Integer.parseInt(caseNumber.split("-")[0].substring(3));
    ...
    public static int getYearOutOfCaseNumber(String caseNumber) {
        ...
        if(!caseNumber.startsWith("CBM") || !caseNumber.contains("-") || caseNumber.length()!=13 ){
