...
import day33.MethodWithReturnPractice3;
...
public class Importing {
    ...
    public static void main(String[] args) {
        ...
        int result1 = MethodPracticeWithNumbers.build3DigitNumber(6, 4, 0);
        System.out.println("result1 = " + result1);

        int result2 = MethodWithReturnPractice3.calculateAgeFromBirthYear(1976);
        System.out.println("Your age is " + result2);
        System.out.println(MethodWithReturnPractice3.calculateAgeFromBirthYear(1985));
