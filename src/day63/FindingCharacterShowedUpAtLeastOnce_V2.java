...
public class FindingCharacterShowedUpAtLeastOnce_V2 {
    public static void main(String[] args) {
     ...
     //   Set<Character>chars = new HashSet<>(Arrays.asList('A','A','A','A','A'));
        //instead of going through each and every character, I want to turn this String into a String
        //array of each character, then turn it tinto a List with Arrays.asList, eventually creating a
        //HashSet object by copying everything inside this list
