...
//            }
//        }
//        System.out.println("Count of Chevrolet: " + countChevrolet);
//        System.out.println("Count of Civic: " + countCivic);
        ...
        for (int i = 0; i < cars.length; i++) {
            ...
            if(cars[i].equals("Honda-Civic")){
                System.out.println("Civic is at : " + i);
            }
        }
...
//      Honda-Civic -->
        ...
        System.out.println("Car make is " + HondaCarSplitted[0] + " and car model is " + HondaCarSplitted[1]);

        for(String eachCar : cars){
            if(eachCar.startsWith("Hyundai")){
                String[]eachCarSplitted = eachCar.split("-");
                System.out.println("Car make is " + eachCarSplitted[0] + " and car model is " + eachCarSplitted[1]);
            }
        }

        //Task 4 : find all the car with model has only 2 characters, print out, get count
        int Char2CarCount = 0;
        for(String Char2Cars : cars){
            String[]CarSplitted = Char2Cars.split("-");
            if(CarSplitted[1].length()==2 && CarSplitted.length <= 2){
                Char2CarCount++;
                System.out.println(Char2Cars);
            }
        }
        System.out.println(Char2CarCount);

        int Char3CarCount = 0;
        for(String Char3Cars : cars){
            String[]CarSplitted = Char3Cars.split("-",2);
            if(CarSplitted[1].length()==2){
                Char3CarCount++;
                System.out.println(CarSplitted[0]  + "-" + CarSplitted[1]);
            }
        }
        System.out.println(Char3CarCount);


        Arrays.sort(cars);
        System.out.println("Sorted cars: " + Arrays.toString(cars));
